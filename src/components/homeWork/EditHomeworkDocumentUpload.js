...
class EditHomeworkDocumentUpload extends React.Component {
                    ...
                    <Col xs={24} sm={12} md={8} lg={6} xl={4} key={index}>
                      <div className="imgdiv photo">
                        <div className="img_wrap">
                          {isImageOrFile(
                            document.ext ? document.ext : document?.file?.type
                          ) ? (
                            <img
                              src={
                                document.file_url
                        ...
                        <h5>
                          {document.oname ? document.oname : document.file_name}
                        </h5>
...
export default EditHomeworkDocumentUpload;
