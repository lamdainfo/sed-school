...
export default class NoticeBoardDetail extends Component {
  state = {
    showModel: false,
  };
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <span className="d-block">
                Posted On : <strong> 25 October</strong>
              </span>
              <span className="d-block">
                Category :
                <span
            ...
            <div className="col-md-8 text-right">
              ...
              &nbsp;&nbsp;
              <NoticeBoardComment hideParentModel={this.hideModel} />
              &nbsp;&nbsp;
              <span className="text-primary">
          ...
          <div className="row">
            <div className="col-md-12">
              <p>
                Subject :{" "}
                <strong>
                  SUBMISSION OF SA-1 EXAM ANSWER NOTEBOOKS (class 1 to Class 5
                  only)
                </strong>
              </p>
              <hr />
